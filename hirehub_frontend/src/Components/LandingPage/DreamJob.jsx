      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-6 pt-3">
          <div>
            ...
            <h1 className="text-accent-custom display-3 fw-bold">
              Turn Your <span className="text-highlight-custom">Ambitions</span>{" "}
              into <span className="text-highlight-custom">Reality</span> with
              HireHub
            </h1>
        ...
        <div className="col-md-6 text-end position-relative">
          ...
          <div className="d-flex flex-column align-items-center text-center glass-effect position-absolute top-50 end-0 translate-middle-y me-2">
            ...
            <div className="text-muted fs-6 mb-2">10k+ jobs got</div>
